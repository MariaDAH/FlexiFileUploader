...
export default function Analytics() {
  ...
  const dataPieChart = GetPieChartConfiguration({ data: dataset }) ?? {
    data: [],
    option: {},
  };
  const dataLineChart = GetLineChartConfiguration({ data: dataset }) ?? {
    data: [],
    option: {},
  };
  const dataBarChart = GetBarChartConfiguration({ data: dataset }) ?? {
    data: [],
    option: {},
  };
